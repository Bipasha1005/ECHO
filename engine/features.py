...
try:
    ...
    from config import ASSISTANT_NAME, LLM_KEY
    from helper import extract_yt_term, markdown_to_text, remove_words
...
def hotword():
    ...
    try:
        ...
        porcupine=pvporcupine.create(keywords=["echo"]) 
        ...
        while True:
            ...
            if keyword_index>=0:
                ...
                try:
                    from engine.command import startContinuousMode
                except ModuleNotFoundError:
                    from command import startContinuousMode
